...
class Coco80DetectedObject(BaseDetectedObject):
    def __init__(self, img: np.array, pred_score: float, pred_cls_name: str):
        super(Coco80DetectedObject, self).__init__()
        self.img: np.array = img
        self.pred_score = pred_score
        self.pred_cls_name = pred_cls_name
        self.pred_cls_idx = coco80_info.get_index(self.pred_cls_name)
        self.track_id = None
